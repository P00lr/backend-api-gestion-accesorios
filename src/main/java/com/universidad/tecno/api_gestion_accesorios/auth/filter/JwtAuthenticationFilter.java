...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    // Inyectamos el AuthenticationManager necesario para realizar la autenticación
    // del usuario.
    public JwtAuthenticationFilter(AuthenticationManager authenticationManager) {
        this.authenticationManager = authenticationManager;
    }

    // Este método se llama automáticamente cuando un usuario envía una solicitud de
    // login (POST a /login).
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Este manager usa los UserDetailsService y PasswordEncoder configurados en el
            // sistema.
    ...
    // Este método se ejecuta automáticamente si el login fue exitoso (credenciales
    // válidas).
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        MainUser user = (MainUser) authResult.getPrincipal();
        ...
        // Creamos un mapa con los "claims" (datos personalizados) que queremos incluir
        // en el token.
        Map<String, Object> claims = new HashMap<>();
        // Agregamos las autoridades como JSON para luego poder reconstruirlas en el
        ...
        //body.put("userId", String.valueOf(user.getId())); // Opcional: también en cuerpo JSON
